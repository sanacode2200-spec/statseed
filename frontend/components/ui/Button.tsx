...
export function Button({
  ...
  const base =
    "inline-flex min-h-11 items-center justify-center rounded-md px-3 py-1.5 text-[13px] font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed sm:min-h-0";
  const styles =
    variant === "primary"
